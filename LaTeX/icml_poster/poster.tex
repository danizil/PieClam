...
\usepackage[size=custom,width=152,height=91,scale=1.3]{beamerposter} % default
...
\logoleft{\includegraphics[height=6cm]{images/ICML-logo.png}}
\logoright{\includegraphics[height=9cm]{technion logo.png}}
...
\newcommand{\columntitle}[1]{
  ...
  \begin{center}
    \color{white}
    \fcolorbox{black}{blue!70!black}{\parbox{0.9\columnwidth}{\centering\LARGE\bfseries #1}}
  \end{center}
  \vspace{1em}
}
...
\begin{column}{\colwidth}
  ...
  \begin{block}{Graph Representation Learning}
    ...
    \textbf{Goal}:
    % \vspace{-0.8em}
    Build a \textbf{universal auoencoder}, which can represent any graph $G$ of any size $N$ with a fixed budget of parameters per node $C$.
    % \end{itemize}
  \end{block}

  \begin{block}{BigClam: Inclusive Community Affiliation}
  ...
  \begin{alertblock}{Bipartite Blindness Of BigClam}
    ...
    \begin{figure}
        ...
        \includegraphics[width=\textwidth]{images/bipart/Simple_bipartite_graph.png}    
    ...
    \begin{figure}    
        \begin{minipage}{0.25\columnwidth}
            \includegraphics[width=\textwidth]{images/bipart/feat_vs_feat_bigclam_30nodes.png}
        \end{minipage}
        \hspace{3em}
 ...
 \sumstrangers{\mathbf{f}_n^\top \mathbf{L} \mathbf{f}_m}\Big)\]
    ...
    \begin{figure}
      ...
      \begin{minipage}{0.3\columnwidth}
        \includegraphics[width=\textwidth]{images/bipart/feat_vs_node_30nodes_green.png}
      \end{minipage}
      ...
      \end{minipage}
      \caption{Bipartite encoding with IeClam. Left: community value per node. Center: embedding in $\mathcal{T}^1$, Left: reconstucted adjacency.}
    \end{figure}
...
\begin{column}{\colwidth}
  ...
  \begin{exampleblock}{Universality in Autoencoders}
     ...
     A family of code spaces $\mathbb{R}^M$ and decoders $D_M:\mathbb{R}^{2M}\rightarrow[0,1]^{N\times N}$ is \textbf{universal} w.r.t. to the distance $d(.,.)$ if for every $\epsilon>0$ there is $M\in\mathbb{N}$ (depending only on $\epsilon$) such that for every $N\in\mathbb{N}$ and every graph with adjacency matrix $\mathbf{A}\in[0,1]^{N\times N}$ there are $N$ points $\{z_n\in\mathbb{R}^M\}_{n=1}^N$ such that 
...
\begin{block}{Universality Theorem for IeClam}
  \textbf{Theorem:} IeClam (and hence PieClam) is universal with respect to the log cut distance.

 \textbf{Asymptotics}: Universality requires $O(\epsilon^{-2})$ communities in unrestricted space, $O(2^{\frac{1}{\epsilon^2}})$ in pairwise cone space.
...
\begin{column}{\colwidth}
  ...
  % \begin{block}{Synthetic Data}
    ...
    Sample nodes from synthetic priors (circles in $\mathcal{T}$, moons in $\mathbb{R}^2_+$) and connect with clam probability.
    Reset affiliation features and fit models to reconstruct shapes
    \begin{figure}
      ...
      \end{minipage}
      \hfill
      \raisebox{0.5\height}{$\xrightarrow{\text{initialize}}$}
      \hfill
      \begin{minipage}{0.25\textwidth}
        \includegraphics[width=\textwidth]{images/circle/circ_initialization.png}
      \end{minipage}
      \hfill
      \raisebox{0.5\height}{$\xrightarrow{\text{train}}$}
      \hfill
      \begin{minipage}{0.25\textwidth}
        \includegraphics[width=\textwidth]{images/circle/pieclam_circ_reconstruct_no_edge.png}
      \end{minipage}
      ...
      % \end{minipage}
      \caption{Node features sampled from synthetic priors in $\mathcal{T}$ and reconstructed with PieClam}
    \end{figure}
    \textbf{2. SBM Reconstruction}
    \begin{figure}[H] 
      % \begin{minipage}{0.2\columnwidth} \includegraphics[width=\textwidth]{images/sbm_reconstruction/halfdiag.png} \end{minipage} \hspace{0.5em}
      \begin{minipage}{0.2\columnwidth} \includegraphics[width=\textwidth]{images/bipart/tripart_gt.png} \end{minipage} \hspace{0.5em}
      % \begin{minipage}{0.2\columnwidth} \includegraphics[width=\textwidth]{images/sbm_reconstruction/halfdiag_pieclam/adj.png} \end{minipage} \hspace{0.5em}
      \begin{minipage}{0.2\columnwidth} \includegraphics[width=\textwidth]{images/bipart/tripart_bigclam_6comm.png} \end{minipage} \hspace{0.5em}
      % \begin{minipage}{0.2\columnwidth} \includegraphics[width=\textwidth]{images/sbm_reconstruction/halfdiag_pclam/adj.png} \end{minipage}
      \begin{minipage}{0.2\columnwidth} \includegraphics[width=\textwidth]{images/bipart/tripart_ie_4comm.png} \end{minipage} \hspace{0.5em}
      \caption{Left to right: Original SBM with 3 classes and 9 blocks; Adjacency matrix of the fitted BigClam graph, with six communities; Adjacency matrix of the fitted IeClam graph, with four communities.} 
